...
/// @nodoc
class _$FetchCopyWithImpl<$Res> extends _$HomeEventCopyWithImpl<$Res>
...
class _$HomeStateTearOff {
  ...
  Success success({required List<Pack> packs}) {
    return Success(
      packs: packs,
    );
  }
...
mixin _$HomeState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Pack> packs) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(List<Pack> packs)? success,
...
class _$Success implements Success {
  const _$Success({required this.packs});
  ...
  @override
  String toString() {
    return 'HomeState.success(packs: $packs)';
  }
...
abstract class Success implements HomeState {
  const factory Success({required List<Pack> packs}) = _$Success;
