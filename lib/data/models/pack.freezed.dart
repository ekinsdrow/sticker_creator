...
class _$PackTearOff {
  ...
  _Pack call({required int id, required String name}) {
    return _Pack(
      id: id,
      name: name,
    );
...
class _$_Pack implements _Pack {
  _$_Pack({required this.id, required this.name});
...
abstract class _Pack implements Pack {
  factory _Pack({required int id, required String name}) = _$_Pack;
